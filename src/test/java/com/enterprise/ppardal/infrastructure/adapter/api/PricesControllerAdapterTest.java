...
class PricesControllerAdapterTest {
    ...
    @Test
    void test7_unknownPropertyInRequest() throws Exception {
        String request = """
                {
    ...
    void test8_invalidBrandIdCases(String description, String request) throws Exception {
    ...
    void test9_invalidProductIdCases(String description, String request) throws Exception {
    ...
    void test10_invalidApplicationDateCases(String description, String request) throws Exception {
